...
const NewHabit = () => {
    ...
    return (
        <>
            <h1 className={cs.Title}>Create a new habit</h1>
            <Form>
                ...
                <Row label="Completion settings">
                    <Section>
                        <Label>Type</Label>
                        <Description>
                            A toggle means you either complete the task or not, but with
                            an interval you can specify a number (e.g. "5000 steps").
                        </Description>
                        <div
                            style={{
                                display: "inline-flex",
                ...
                <Row label="Tracking period">
                    <Section>
                        ...
                        <Description>
                            Specify how long you want to track the habit for. You don't
                            have to fill in the 'End' date if you want to keep tracking
                            forever.
                        </Description>
                        {[
